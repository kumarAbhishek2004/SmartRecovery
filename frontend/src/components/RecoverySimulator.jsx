...
export default function RecoverySimulator({ onSimulate, onRecoverPayment, onNavigateToCustomerPortal }) {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="rz-card p-6 bg-gradient-to-r from-[#131b36] via-[#1c2541] to-[#0b132b]">
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-xl bg-[#00d2ff]/15 text-[#00d2ff] border border-[#00d2ff]/30">
            <Zap className="w-6 h-6 fill-[#00d2ff]" />
          </div>
          <div>
            ...
            <p className="text-xs text-slate-300">
              Trigger a simulated <code className="text-[#00d2ff]">payment.failed</code> webhook and watch the multi-agent AI engine diagnose, strategize, and recover the subscription in real-time.
            </p>
          </div>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 pt-3 border-t border-slate-800">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-slate-900 border border-slate-800 text-xs text-slate-100 focus:outline-none focus:border-[#00d2ff]"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-slate-900 border border-slate-800 text-xs text-slate-100 focus:outline-none focus:border-[#00d2ff] font-mono"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 rounded-xl bg-gradient-to-r from-[#3a86ff] via-[#00d2ff] to-[#10b981] text-white font-bold text-sm shadow-lg hover:brightness-110 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 mt-2"
              >
                {loading ? (
                  <>
        ...
        <div className="lg:col-span-7">
          {simulationResult ? (
            <div className="space-y-4">
              ...
              <div className="rz-card p-5 rz-card-glow space-y-4">
                ...
                <div className="space-y-2 p-3 bg-slate-950/80 rounded-xl border border-slate-800 font-mono text-xs max-h-48 overflow-y-auto">
                  {simulationResult.executionLog.map((log, i) => (
                    <div key={i} className="flex items-start gap-2 text-slate-300 border-b border-slate-900 pb-1 last:border-0">
                      ...
                      <span className="text-[#00d2ff] font-bold text-[10px] bg-[#00d2ff]/10 px-1 rounded">{log.step}</span>
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3.5 rounded-xl bg-[#0b2b1a]/60 border border-emerald-500/30 text-xs text-emerald-200 space-y-1 font-sans">
                ...
                <div className="p-4 rounded-xl bg-gradient-to-r from-blue-900/40 via-cyan-900/30 to-slate-900 border border-[#00d2ff]/40 space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-xs text-[#00d2ff] hover:text-white flex items-center gap-1 bg-[#00d2ff]/10 hover:bg-[#00d2ff]/20 px-2 py-1 rounded transition-colors"
                    >
                  ...
                  <div className="text-xs font-mono bg-slate-950 p-2.5 rounded-lg border border-slate-800 text-slate-300 truncate">
                  ...
                  <div className="pt-2 flex flex-col sm:flex-row gap-2">
                    <button
                      ...
                      className="flex-1 py-2.5 px-4 rounded-lg bg-[#00d2ff] hover:bg-[#00c0eb] text-slate-950 font-extrabold text-xs flex items-center justify-center gap-2 cursor-pointer shadow-md"
                    >
            ...
            <div className="rz-card p-12 text-center space-y-4 flex flex-col items-center justify-center min-h-[400px]">
              <div className="p-4 rounded-2xl bg-slate-900 text-slate-500 border border-slate-800">
                <Bot className="w-10 h-10 text-[#00d2ff]" />
              </div>
              <div>
