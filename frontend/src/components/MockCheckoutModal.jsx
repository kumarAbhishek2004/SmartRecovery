  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#050b14]/90 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden relative animate-in fade-in zoom-in duration-200">
        ...
        {/* Header */}
        <div className="bg-[#0b132b] p-6 text-center relative">
          ...
          {isSuccess ? (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-semibold text-slate-500 mb-1 uppercase tracking-wider">Card Number</label>
                  <div className="relative">
                    <input type="text" value="4111 1111 1111 1111" readOnly className="w-full bg-slate-50 border border-slate-200 rounded-lg py-3 px-4 pl-10 text-slate-700 font-mono outline-none" />
                    <CreditCard className="w-5 h-5 text-slate-400 absolute left-3 top-3" />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1 uppercase tracking-wider">Expiry</label>
                    <input type="text" value="12/28" readOnly className="w-full bg-slate-50 border border-slate-200 rounded-lg py-3 px-4 text-slate-700 font-mono outline-none" />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1 uppercase tracking-wider">CVV</label>
                    <input type="password" value="123" readOnly className="w-full bg-slate-50 border border-slate-200 rounded-lg py-3 px-4 text-slate-700 font-mono outline-none" />
                  </div>
                </div>
              </div>
              ...
              <button 
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-500/30 transition-all flex justify-center items-center gap-2 mt-4"
              >
                {isProcessing ? (
